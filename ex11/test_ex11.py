...
def test_build_tree1():
    ...
    records = parse_data(r"D:\Drive Backup\Pycharm_projects\2020 b\ex11\Data\tiny_data2.txt")
...
def test_build_tree2():
    ...
    records = parse_data(r"D:\Drive Backup\Pycharm_projects\2020 b\ex11\Data\small_data1.txt")
...
def test_build_tree3():
    ...
    records = parse_data(r"D:\Drive Backup\Pycharm_projects\2020 b\ex11\Data\medium_data1.txt")
...
def test_build_tree4():
    ...
    records = parse_data(r"D:\Drive Backup\Pycharm_projects\2020 b\ex11\Data\medium_data2.txt")
...
def test_optimal_tree1():
    records = parse_data(r"D:\Drive Backup\Pycharm_projects\2020 b\ex11\Data\test_optimal_tree1.txt")
...
def test_optimal_tree2():
    records = parse_data(r"D:\Drive Backup\Pycharm_projects\2020 b\ex11\Data\test_optimal_tree2.txt")
    tree = optimal_tree(records,["cough", "fever", "headache"],1)

    assert "fever" == tree.data or "headache" == tree.data

def test_optimal_tree3():
    records = parse_data(r"D:\Drive Backup\Pycharm_projects\2020 b\ex11\Data\test_optimal_tree3.txt")
